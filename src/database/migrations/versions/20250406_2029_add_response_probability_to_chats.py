...
def upgrade() -> None:
    ...
    op.add_column(
        "chats", sa.Column("response_probability", sa.Float(), nullable=False, server_default="1.0")
    )
    op.add_column(
        "chats", sa.Column("importance_threshold", sa.Float(), nullable=False, server_default="0.5")
    )
